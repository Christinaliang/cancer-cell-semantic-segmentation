...
def ConvBNReLU(i, o, kernel_size=(3, 3), stride=1, padding=1, bn=True, relu=True, bias=True):
...
def DeConvBNReLU(i, o, kernel_size=(3, 3), stride=1, padding=1, bn=True, relu=True, bias=True):
